...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: /*#__PURE__*/_regeneratorRuntime().mark(function generatePosition() {
      var row, column, id;
      return _regeneratorRuntime().wrap(function generatePosition$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            if (false) {}
            row = Math.floor(Math.random() * this.boardSize);
            column = Math.floor(Math.random() * this.boardSize);
            id = "".concat(row).concat(column);
            _context.next = 6;
            return {
              row: row,
              column: column,
    ...
    key: "createPosition",
    value: function createPosition() {
      var iterator = this.generatePosition();
      var newPosition = iterator.next().value;
      if (!this.position) {
        return newPosition;
      }
